...
end, { desc = "Switch to the left split" })
map("n", "<C-j>", function()
  require("smart-splits").move_cursor_down()
end, { desc = "Switch to the split below" })
map("n", "<C-k>", function()
  require("smart-splits").move_cursor_up()
end, { desc = "Switch to the split above" })
map("n", "<C-l>", function()
  require("smart-splits").move_cursor_right()
end, { desc = "Switch to the right split" })
...
end, { desc = "Swap buffer with left window" })
map("n", "<leader>bj", function()
  require("smart-splits").swap_buf_down()
end, { desc = "Swap buffer with window below" })
map("n", "<leader>bk", function()
  require("smart-splits").swap_buf_up()
end, { desc = "Swap buffer with window above" })
...
end, { desc = "Replace in the buffer (Spectre)" })
...
end, { desc = "Go to impementation (LSP)" })
map("n", "gr", function()
  vim.lsp.buf.references()
end, { desc = "Go to references (LSP)" })
map("n", "gl", function()
  vim.diagnostic.open_float()
end, { desc = "Open diagnostics window (LSP)" })
map("n", "<leader>li", "<cmd>LspInfo<cr>", { desc = "LSP Information" })
map({ "n", "x" }, "<leader>la", function()
...
end, { desc = "Diagnostics loclist (LSP)" })
...
end, { desc = "Load local or latest global session" })
map("n", "<leader>sp", function()
  require("mini.sessions").select "read"
end, { desc = "Pick & load a session" })
...
map("n", "<leader>sw", function()
  ...
  M.write(M.config.file)
end, { desc = "Write a local session" })
map("n", "<leader>sW", function()
  require("mini.sessions").select "write"
end, { desc = "Select & write a session" })
map("n", "<leader>sd", function()
  require("mini.sessions").delete(nil)
end, { desc = "Delete current session" })
map("n", "<leader>sD", function()
  require("mini.sessions").select "delete"
end, { desc = "Select & delete a session" })
...
end, { desc = "Condition-based breakpoint" })
