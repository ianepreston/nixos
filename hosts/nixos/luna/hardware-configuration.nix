...

{
  ...
  fileSystems."/" = {
    device = "/dev/disk/by-path/pci-0000:3c:00.0-nvme-1-part2";
    fsType = "ext4";
  };

  fileSystems."/boot" = {
    device = "/dev/disk/by-path/pci-0000:3c:00.0-nvme-1-part1";
    fsType = "vfat";
    options = [
      "fmask=0077"
      "dmask=0077"
  ...
  swapDevices = [
    { device = "/dev/disk/by-path/pci-0000:3c:00.0-nvme-1-part3"; }
  ];
